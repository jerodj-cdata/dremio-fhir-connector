...
@SourceType(value = "FHIRARP", label = "FHIR",uiConfig = "fhir-layout.json")
public class FHIRConf extends AbstractArpConf<FHIRConf> {
  private static final String ARP_FILENAME = "arp/implementation/fhir-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.fhir.FHIRDriver";
